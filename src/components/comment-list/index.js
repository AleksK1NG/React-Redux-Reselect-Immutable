  ...
  render() {
    ...
    return (
      <div>
        ...
        <CSSTransition transitionName="comments" transitionEnterTimeout={500} transitionLeaveTimeout={500}>
          {this.getBody()}
        </CSSTransition>
      </div>
    )
  ...
  getBody() {
    ...
    return (
      <div className="test__comment-list--body">
        {comments.length ? this.comments : <h3 className="test__comment-list--empty">{t('No comments yet')}</h3>}
